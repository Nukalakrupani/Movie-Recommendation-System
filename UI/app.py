...
reader = Reader()
ratings = pd.read_csv('C:/Users/khaja/Documents/Movie-Recommendation-System-using-Machine_learning/data/ratings_small.csv')
...
id_map = pd.read_csv('C:/Users/khaja/Documents/Movie-Recommendation-System-using-Machine_learning/data/links_small.csv')[['movieId', 'tmdbId']]
...
def home_submit():
    ...
    if movie_name not in indices1.values:
